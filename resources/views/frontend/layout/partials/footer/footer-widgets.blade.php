			...
			<div class="widget clearfix">
				...
				<div style="background: url('{!! asset('frontend/images/world-map.png') !!}') no-repeat center center; background-size: 100%;">
					...
					<div itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
						<div>
							<span itemprop="streetAddress" style="display:block;">2225 South 3200 West </span>
							<span itemprop="addressLocality" style="display:inline">West Valley City</span>, <span itemprop="addressRegion" style="display:inline">UT</span>
						</div>
			...
			<div class="widget clearfix">
				...
				<div class="media">
					...
					<div class="media-body">
						<span class="media-heading"><a href="{!! URL::route('dashboard.article.show', array('slug'=>$article->slug)) !!}">{!! $article->title !!}</a></span><br>
