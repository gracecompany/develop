                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="table-product-name">
                            <a href="{!! url('/admin/product/'.$product->id.'/edit') !!}" class="fa fa-pencil-square-o fa-lg">
                                    &nbsp; {!! $product->name !!}
                            </a>
                        </td>
						<td colspan="2">{!! $product->sku !!} / {!! $product->upc !!}</td>
                    ...
                    {{-- 	<td>
                        ...
                        <td colspan="2" class="text-center ">
                            ...
                            <a target="_blank" href="{!! url(getLang().'/product/' . $product->slug .'/show') !!}" class="preview btn btn-sm btn-danger"><i class="fa fa-eye"></i>&nbsp; Preview</a>
