...
@section('pagetitle')
    <div class="row">
        <div class="col-sm-12">
            ...
            <li><a href="{!! route('admin.dealers') !!}"><i class="fa fa-gears"></i>  Dealer</a></li>
            ...
            <!-- end: PAGE TITLE & BREADCRUMB -->
                          <div class="space12">
                            <div class="btn-group btn-group-lg">
                                <a class="btn btn-default" href="{!! route('admin.dealers') !!}">Dealers </a>
                                <a class="btn btn-default hidden-xs" href="{!! route('admin.dealers.create') !!}">
                                  <i class="fa fa-plus"></i> Update Dealer </a>
                            </div>
                        </div>
        </div>
    </div>
